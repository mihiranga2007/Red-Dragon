...
║🌹.ᴍᴇɴᴜ = *ක්මාන්ඩ් ලිස්ට්*

║ *ලබා ගැනීම...💫*

║🤭━━━━━━━━━━━

║🌹 .ꜱᴏɴɢ =  *සින්දු ලබා ගැනීමට හැක

║🍭.song lelena

║🤭━━━━━━━━━━

║🌹.ʟᴏɢᴏ1= *ලෝගෝ සාදා ගැනීම💫*

║🍭.logo1 janith

║🤭━━━━━━━━━━━

║🌹.ᴠɪᴅᴇᴏ = *විඩියෝ ලබා ගැනීම💫*

║🍭.video https://youtube.com/watch?v=iurZ0ncyiqg

║🤭━━━━━━━━━━━━

║🌹find apk = *apk sarching menu💫*

║🍭.findapk snapseed

║🤭━━━━━━━━━━━━

║ *~_✨200MB අඩූ හොදේ ɪɴʙᴏx ඇවිත් වද දෙන්නෙපා✨_~*
...
🅳𝗦𝙵 S̷H͜͡A͞G░G༙྇Y҈☚˜ᵀᴹ` //Costomize Alive Message (type your message in `` )
...
global.ownername = "🍃⃝⃔𝚃ᴼᵂᴹᴱ۞͢͠ 𝕾𝕳𝕬𝕲𝕲𝖄❩™" // owner name
global.ytname = "DK OFFICIAL " // yt chanel name
global.socialm = "GitHub: MIHIRANGA2007" // github or insta name
global.location = "India, Mizoram, Aizawl" // location

//bot body 
global.alivepic = `https://ibb.co/kgPfHPP` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.botname = 'ॐ⃞𝐌ᴬෆි⃝𝚢αᵂ͢ᴱ᳀ශැගීහ්🌙⃯™᭄- 𝘉𝘖𝘛' //ur bot name
global.packname = "🍃⃝⃔𝚃ᴼᵂᴹᴱ۞͢͠ 𝕾𝕳𝕬𝕲𝕲𝖄❩™ Sticker" // sticker packname
global.author = "◌◌◌◌◌" // sticker author
global.dragonemoji = '❤️' // Menu emoji
global.footer = '[ ᴛᴏͥ͢ᴡᴍͣᴇͫ᭕🅢🅗🅐🅖🅖🅨࿐]' //
...
global.mess = {
    ...
    caption: 'Generated by: ◉ *᳆⃞🇱🇰⃟ ʀͥᴇᷧᴀͫʟ☞𝐝𝐚𝐫𝐤 𝐬𝐡𝐚𝐠𝐠𝐲😌*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
